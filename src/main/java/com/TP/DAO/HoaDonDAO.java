...
//		
    ...
    public Map<String, BigInteger> getProductSellbyCat() {
        ...
        String query = "SELECT t.tendanhmuc,count(t.soluong) as soluong FROM\n" +
                " (SELECT sp.madanhmuc,dm.tendanhmuc , cthd.soluong FROM  ( ( (heroku_b4cf90579b085ec.chitiethoadon  cthd inner join heroku_b4cf90579b085ec.hoadon hd)   inner join heroku_b4cf90579b085ec.chitietsanpham ctsp  )\n" +
                "															inner join heroku_b4cf90579b085ec.sanpham sp  )  inner join heroku_b4cf90579b085ec.danhmucsanpham dm\n" +
    ...
    public boolean CheckBillUserDelivered(int masanpham, String tenkhachhang) {
        ...
        Session session = sessionFactory.getCurrentSession();
        String query = " SELECT hd.tenkhachhang FROM  heroku_b4cf90579b085ec.chitiethoadon  cthd inner join heroku_b4cf90579b085ec.hoadon hd inner join chitietsanpham ctsp " +
