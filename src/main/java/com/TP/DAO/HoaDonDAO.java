...
//		
    ...
    public Map<String, BigInteger> getProductSellbyCat() {
        ...
        String query = "SELECT t.tendanhmuc,count(t.soluong) as soluong FROM\n" +
                " (SELECT sp.madanhmuc,dm.tendanhmuc , cthd.soluong FROM  ( ( (tpminishop.chitiethoadon  cthd inner join tpminishop.hoadon hd)   inner join tpminishop.chitietsanpham ctsp  )\n" +
                "															inner join tpminishop.sanpham sp  )  inner join tpminishop.danhmucsanpham dm\n" +
    ...
    public boolean CheckBillUserDelivered(int masanpham, String tenkhachhang) {
        ...
        Session session = sessionFactory.getCurrentSession();
        String query = " SELECT hd.tenkhachhang FROM  tpminishop.chitiethoadon  cthd inner join tpminishop.hoadon hd inner join chitietsanpham ctsp " +
