...
public class HoaDonDAO implements IHoaDon {
    ...
    public BigInteger getBillsuccess() {
        ...
        return (BigInteger) session.createNativeQuery(query).list().get(0);
    }
    ...
    public int getTotalrevenue() {
        ...
        Double sum = (Double) session
                .createNativeQuery("SELECT SUM(REPLACE(tongtien, '.', '')) FROM HOADON WHERE tinhtrang=" + tinhtrang + "")
                .getSingleResult();
        if (sum != null) {
            return sum.intValue();
        }
...
//		
    ...
    public Map<String, BigInteger> getProductSellbyCat() {
        ...
        String query = "SELECT t.tendanhmuc,count(t.soluong) as soluong FROM\n" +
                " (SELECT sp.madanhmuc,dm.tendanhmuc , cthd.soluong FROM  ( ( (heroku_8b050971d97876a.chitiethoadon  cthd inner join heroku_8b050971d97876a.hoadon hd)   inner join heroku_8b050971d97876a.chitietsanpham ctsp  )\n" +
                "															inner join heroku_8b050971d97876a.sanpham sp  )  inner join heroku_8b050971d97876a.danhmucsanpham dm\n" +
    ...
    public boolean CheckBillUserDelivered(int masanpham, String tenkhachhang) {
        ...
        Session session = sessionFactory.getCurrentSession();
        String query = " SELECT hd.tenkhachhang FROM  heroku_8b050971d97876a.chitiethoadon  cthd inner join heroku_8b050971d97876a.hoadon hd inner join chitietsanpham ctsp " +
