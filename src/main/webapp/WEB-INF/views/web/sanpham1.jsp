        ...
        <div class="new-product">
            <div class="new-product-top">
                <ul class="product-top-list">
                    <li><a href='<c:url value="/"/>'>Trang chủ</a>&nbsp;<span>&gt;</span></li>
                    <li><span class="act">${tendanhmuc}</span>&nbsp;</li>
                </ul>
                <p class="back">
                    <a href='<c:url value="/"/>'>Trở về trang chủ</a>
                </p>
                    ...
                    <c:forEach var="sanpham" items="${listSanPham}">
                        <li><a class="cbp-vm-image"
                            ...
                            <div class="simpleCart_shelfItem">
                                    ...
                                    <div class="view view-first">
                                        <div class="inner_content clearfix">
                                            <div class="product_image">
                                                ...
                                                <div class="mask">
                                                    <div class="info">Xem chi tiết</div>
                                                </div>
                                ...
                                <div class="cbp-vm-details">${sanpham.getMota()}</div>
                        </li>
                    </c:forEach>
                </ul>
