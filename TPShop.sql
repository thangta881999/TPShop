...
--
-- Host: localhost    Database: heroku_252ed540f9e5ac3
-- ------------------------------------------------------
...
# INSERT INTO `heroku_252ed540f9e5ac3`.`sanpham` (`masanpham`, `madanhmuc`, `tensanpham`, `giatien`, `mota`, `hinhsanpham`, `danhcho`) VALUES ('20', '3', 'Quần Short Kaki Y2010 BD-A63', '255.000', 'Chất liệu: Kaki<br>Thành phần: 100% Cotton<br>- Vải kaki có tính chất chung là bền, mát, co giãn', '25.jpg', 'Nam');
...
# INSERT INTO `heroku_252ed540f9e5ac3`.`sanpham` (`masanpham`, `madanhmuc`, `tensanpham`, `giatien`, `hinhsanpham`, `danhcho`) VALUES ('22', '3', 'Quần Short Jean Y2010 B10', '295.000', '27.jpg', 'Nam');
...
-- insert into `heroku_252ed540f9e5ac3`. `review` (`userId`,`masanpham`,`rating`) values (1,1,5),(2,1,5),(3,1,2),(4,1,0),(5,1,1),
...
# IF (flag = 0) THEN
# begin
# insert into `heroku_252ed540f9e5ac3`.`review` (`userId`,`masanpham`,`rating`) values (user_Id,msp,rating);
#
# end;
#
# END IF;
