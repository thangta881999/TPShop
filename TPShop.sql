...
--
-- Host: localhost    Database: heroku_6640a1c02ae9e7a
-- ------------------------------------------------------
...
INSERT INTO `DANHMUCSANPHAM`(`madanhmuc`,`tendanhmuc`,`parent_madanhmuc`) VALUES (9,'Túi',0),(10,'Túi đeo chéo',0);
...
INSERT INTO `SANPHAM` VALUES (1,2,'Sơ Mi Nam Y2010 TD A04','185.000','Chất liệu: Vải Ford <br>Thành phần: 60% cotton 40% poly <br>- Mềm mại, mát mẻ<br>- Thoải mái và bền','1.jpg','Nam'),
                             ...
                             (14,10,'Túi Đeo Y2010 B08','185.000',
...
INSERT INTO `heroku_6640a1c02ae9e7a`.`sanpham` (`masanpham`, `madanhmuc`, `tensanpham`, `giatien`, `hinhsanpham`, `danhcho`) VALUES ('22', '6', 'Quần Short Jean Y2010 B10', '295.000', '27.jpg', 'Nam');
...
-- insert into `heroku_6640a1c02ae9e7a`. `review` (`userId`,`masanpham`,`rating`) values (1,1,5),(2,1,5),(3,1,2),(4,1,0),(5,1,1),
...
# IF (flag = 0) THEN
# begin
# insert into `heroku_6640a1c02ae9e7a`.`review` (`userId`,`masanpham`,`rating`) values (user_Id,msp,rating);
#
# end;
#
# END IF;
