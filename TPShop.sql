...
--
-- Host: localhost    Database: heroku_c613eec4aea8a3c
-- ------------------------------------------------------
...
INSERT INTO `heroku_c613eec4aea8a3c`.`sanpham` (`masanpham`, `madanhmuc`, `tensanpham`, `giatien`, `mota`, `hinhsanpham`, `danhcho`) VALUES ('20', '3', 'Quần Short Kaki Y2010 BD-A63', '255.000', 'Chất liệu: Kaki<br>Thành phần: 100% Cotton<br>- Vải kaki có tính chất chung là bền, mát, co giãn', '25.jpg', 'Nam');
...
INSERT INTO `heroku_c613eec4aea8a3c`.`sanpham` (`masanpham`, `madanhmuc`, `tensanpham`, `giatien`, `hinhsanpham`, `danhcho`) VALUES ('22', '3', 'Quần Short Jean Y2010 B10', '295.000', '27.jpg', 'Nam');
...
-- insert into `heroku_c613eec4aea8a3c`. `review` (`userId`,`masanpham`,`rating`) values (1,1,5),(2,1,5),(3,1,2),(4,1,0),(5,1,1),
...
body :begin
    ...
    while v_index < v_masanphammax do
            ...
            IF (flag = 0) THEN
                begin
                    insert into `heroku_c613eec4aea8a3c`. `review` (`userId`,`masanpham`,`rating`) values (user_Id,msp,rating);
