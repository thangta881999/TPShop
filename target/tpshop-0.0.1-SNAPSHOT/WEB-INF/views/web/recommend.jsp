            ...
            <div class="row" id="listproducts" name="listproducts">
                <c:if test="${listSanPhams.size()==0}">
                    <div
                        ...
                        <a class="product_name" href="/">Không có sản phẩm gợi ý cho bạn.Vui lòng đánh giá khi mua sản
                            phẩm để được gợi ý</a>
                    </div>
                </c:if>
                <c:if test="${listSanPhams.size()>0}">
                    <c:forEach var="sanpham" items="${listSanPhams}">
                        <div
                            ...
                            <a class="product_name"
                               href="chitiet/${sanpham.getMasanpham()}">${sanpham.getTensanpham()}</a>
                            <p>
